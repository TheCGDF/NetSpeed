...
VOID Registry::Position_Delete() {
	RegDeleteKeyValueW(HKEY_CURRENT_USER, REGISTRYPATH_POSITION, REGISTRYVALUE_POSITION_X);
	RegDeleteKeyValueW(HKEY_CURRENT_USER, REGISTRYPATH_POSITION, REGISTRYVALUE_POSITION_Y);
}
